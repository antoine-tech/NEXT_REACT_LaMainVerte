...
const Profile = () => {
  ...
  return (
    <section className="grid grid-cols-12 min-h-screen gap-4 bg-light-brown">
      <div className="hidden md:block md:col-span-1 lg:col-span-2 bg-man relative"></div>
      <div className="flex flex-col col-span-12 lg:col-span-10 grid grid-cols-2 gap-4 ">
        <div className="col col-span-2 lg:col-span-1 h-screen overflow-auto">
